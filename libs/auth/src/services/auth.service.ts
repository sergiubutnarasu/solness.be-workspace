...
import { CryptoHelper, DateHelper, StringHelper } from '@solness/core';
import { EmailService } from '@solness/email';
...
export class AuthService {
  ...
  public async validateUser(username: string, password: string) {
    const user = await this.userService.getUserForValidation(username);
